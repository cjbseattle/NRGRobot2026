...
The robot code of FRC Team 948 - Newport Robotics Group for FIRST Robotics Competition 2026 REBUILT presented by Haas game.
...
3. Clone the repository.
    ...
    * Windows
        ...
        ```powershell
        git clone https://github.com/NRG948/NRGRobot2026.git
        ```
    ...
    * Linux/MacOS
        ...
        * Clone the repository.
            ...
            ```sh
            git clone git@github.com:NRG948/NRGRobot2026.git
            ```
...
* Linux/MacOS
    ...
    ```sh
    ./gradlew build -Dorg.gradle.java.home="~/wpilib/2026/jdk" 
    ```
...
* Windows
    ...
    ```powershell
    PS> ./gradlew deploy -Dorg.gradle.java.home="C:\Users\Public\wpilib\2026\jdk" 
    ```

* Linux/MacOS

    ```sh
    ./gradlew deploy -Dorg.gradle.java.home="~/wpilib/2026/jdk" 
    ```
